// O watched list permite que apenas operações realmente necessárias de adição, remoção e atualização sejam executadas no banco de dados. Ele não adiciona e remove um item de forma duplicada.
